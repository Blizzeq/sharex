        ...
        <div className={'reset Regular'}>
            <div className={'w-full h-screen flex justify-center items-center'}>
                <div className={'w-6/12'}>
                    ...
                    <p className={'text-gray flex justify-center mb-4 text-center'}>Enter your email address and we’ll send you an email with instructions to reset your password</p>
